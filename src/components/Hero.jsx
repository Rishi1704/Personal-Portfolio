...
const Hero = () => {
  return (
    <section className='relative w-full h-screen mx-auto translate-y-[-70px]'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-auto items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-while-100`}>I a Full Stack Game Developer, a Software Developer 
          <br className='sm:block hidden' />and a Frontend Web Developer</p>
        </div>
      </div>
